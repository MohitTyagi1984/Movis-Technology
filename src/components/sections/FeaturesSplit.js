...
const FeaturesSplit = ({
  ...
  const sectionHeader = {
    title: 'Welcome',
    paragraph: 'Movis is a provider of IT Consulting and Software Development services. Our specialize into designing, implementing and supporting technology-based solutions. We Have started as a small IT company, and ever since we have helped Non-IT Organizations to improve business performance and quickly win new customers.'
  };
          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                Movis Developments is an independent
                Software Delopment and Website Designing Company in Delhi NCR, India.
                  </div>
              ...
              <div className={
                ...
                <Image
                  src={require('./../../assets/images/aboutus1.png')}
